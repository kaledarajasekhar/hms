	...
	<div class="form-container">
		<form action="adddoctor" method="POST">
			...
			<input type="text" name="name" placeholder="Enter Doctor Name"
				...
				placeholder="Enter Doctor Age" required> <input type="text"
				name="gender" placeholder="Enter Doctor Gender" required> <input
				type="text" name="phone" placeholder="Enter Doctor Phone" required>
